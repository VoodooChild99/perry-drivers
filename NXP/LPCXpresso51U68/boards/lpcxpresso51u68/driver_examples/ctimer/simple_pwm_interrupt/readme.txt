...
Running the demo
================
The log below shows example output of the CTimer simple PWM demo using interrupts in the terminal window, you could also monitor the PWM signal on J2-5.
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
