...
void SPI_Master_IRQHandler(SPI_Type *base, spi_master_handle_t *handle) {
    SPI_MasterTransferHandleIRQ(base, handle);
}

void SPI_Slave_IRQHandler(SPI_Type *base, spi_slave_handle_t *handle) {
    SPI_SlaveTransferHandleIRQ(base, handle);
}